        ...
        <div className="bg-white p-8 border shadow-sm my-8 mx-2">
            ...
            <div className="py-8">
                <h3 className="text-lg">
                    ...
                    Architecto praesentium distinctio excepturi dolor, nihil
                    unde exercitationem eligendi sit quam nemo cumque, tenetur
                    hic, quasi atque. Fuga saepe vitae cum quasi!
                </h3>
            </div>
        </div>
    );
