        ...
        const fetchVideo = async () => {
            ...
            try {
                const response = await axios.get(
                    `https://api.flexedu-dz.com/Teachers/${user?.id}/Courses/${CourseId}/Videos/${VedioId}`,
                    {
    ...
    const DeleteVedio = async () => {
        ...
        try {
            const response = await axios.delete(
                `https://api.flexedu-dz.com/upload/Courses/${videoData.Course?.id}/Vedios/${videoData.id}`,
                {
                    withCredentials: true,
                    validateStatus: () => true,
                }
