...
function Laptop_Nav_Items({ Active_nav, handleLogout, LogoutClicked }) {
    ...
    const Delete_Notification = (id) => {
        ...
        axios.delete(
            `https://api.flexedu-dz.com/Teachers/${user?.id}/Notifications/${id}`,
    ...
    return (
        <div className="hidden  md:flex  items-center justify-between mx-2 lg:mx-12  md:text-md lg:text-lg  font-[500] text-black_text h-full p-2 ">
            <div>
                <Link to={"/Teacher"} className="select-none">
                    <img
                        src={Logo}
                        alt="Logo"
            ...
            <div className="flex gap-6 lg:gap-14">
                ...
                >
                    <Link to={"/Teacher/Contact"} className={" select-none"}>
                        Contact{" "}
                    </Link>
                </div>{" "}
                <div
                ...
                >
                    <Link to={"/Teacher/Profile"} className={" select-none"}>
                        Profile{" "}
                    </Link>
                </div>
                <div
