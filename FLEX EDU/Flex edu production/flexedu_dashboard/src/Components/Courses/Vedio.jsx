        ...
        const fetchVideo = async () => {
            ...
            try {
                const response = await axios.get(
                    `https://api.flexedu-dz.com/Admin/Courses/${CourseId}/Videos/${VedioId}`,
                    {
    ...
    const DeleteVedio = async () => {
        ...
        try {
            const response = await axios.delete(
                `https://api.flexedu-dz.com/Admin/upload/Courses/${videoData.Course?.id}/Vedios/${videoData.id}`,
                {
                    withCredentials: true,
                    validateStatus: () => true,
                }
        ...
        <div className="w-full h-screen">
            ...
            {videoAvailable ? (
                <div className="w-full h-[80vh] bg-black">
                    ...
                    >
                        <source
                            src={`https://api.flexedu-dz.com${videoData.Video}`} // Video URL
                            type="video/mp4"
                        />
