...
function Payment() {
        ...
        const fetchSummaryDetails = async () => {
            try {
                const response = await axios.get(
                    `https://api.flexedu-dz.com/Admin/Payment/Summaries/${summaryId}`,
                    {
    ...
    const handleAccept = async () => {
        ...
        try {
            const response = await axios.post(
                `https://api.flexedu-dz.com/Admin/Payment/Summaries/${summaryId}/Accept`,
                {
    ...
    const handleReject = async () => {
        ...
        try {
            const response = await axios.post(
                `https://api.flexedu-dz.com/Admin/Payment/Summaries/${summaryId}/Reject`,
                {
                    studentId: summary.StudentId,
                },
                {
            ...
            {summary?.screenShot && (
                <div className="pt-8">
                    <div className="flex justify-center w-full">
                        <a
                            href={`https://api.flexedu-dz.com${summary.screenShot}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <img
                                src={`https://api.flexedu-dz.com${summary.screenShot}`}
