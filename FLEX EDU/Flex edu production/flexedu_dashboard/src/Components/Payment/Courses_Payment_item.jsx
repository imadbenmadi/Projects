...
function Payment() {
        ...
        const fetchCourseDetails = async () => {
            try {
                const response = await axios.get(
                    `https://api.flexedu-dz.com/Admin/Payment/Courses/${courseId}`,
                    {
    ...
    const handleAccept = async () => {
        ...
        try {
            const response = await axios.post(
                `https://api.flexedu-dz.com/Admin/Payment/Courses/${courseId}/Accept`,
                {
    ...
    const handleReject = async () => {
        ...
        try {
            const response = await axios.post(
                `https://api.flexedu-dz.com/Admin/Payment/Courses/${courseId}/Reject`,
                {
                    studentId: course?.StudentId,
                },
                {
            ...
            {course?.screenShot && (
                <div className="pt-8">
                    <div className="flex justify-center w-full">
                        <a
                            href={`https://api.flexedu-dz.com${course?.screenShot}`}
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <img
                                src={`https://api.flexedu-dz.com${course?.screenShot}`}
