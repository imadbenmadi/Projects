        ...
        const fetchData = async () => {
            try {
                ...
                const [coursesResponse, summariesResponse] = await Promise.all([
                    axios.get(
                        `https://api.flexedu-dz.com/Admin/Payment/Courses/Accepted`,
                        {
                    ...
                    axios.get(
                        `https://api.flexedu-dz.com/Admin/Payment/Summaries/Accepted`,
                        {
                            withCredentials: true,
                            validateStatus: () => true,
                        }
                        ...
                        <div className="w-full flex gap-12 justify-center py-4">
                            <div className="max-w-[300px] border shadow-md py-6 px-6 flex flex-col items-center justify-start rounded-md md:min-w-[200px]">
                                <div className="text-xs font-semibold pb-5 text-gray_v w-full">
                                    Total Number of Accepted Payment:
                                </div>
...
export default Accepted_Payments;
