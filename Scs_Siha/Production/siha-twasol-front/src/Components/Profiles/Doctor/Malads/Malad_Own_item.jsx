        ...
        const fetchMalad = async () => {
            try {
                const response = await axios.get(
                    `https://api.scs-tawassolsihi.com/Doctors/${user.id}/Malads/Own/${id}`,
    ...
    const handle_delete = async (id) => {
        ...
        try {
            const response = await axios.delete(
                `https://api.scs-tawassolsihi.com/Doctors/${user.id}/Malads/${malad.id}`,
                { withCredentials: true }
            );
            ...
            >
                ...
                <div className="border-b pb-4 mb-4">
                    ...
                    {malad?.profile_pic_link ? (
                        <img
                            loading="lazy"
                            src={`https://api.scs-tawassolsihi.com/${malad?.profile_pic_link}`}
                            alt="Profile"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {files.map((file) => (
                                ...
                                >
                                    ...
                                    <a
                                        href={`https://api.scs-tawassolsihi.com/${file.file_link}`}
                                        target="_blank"
                                        rel="noreferrer"
