...
const ChatRoom = () => {
    ...
    const chatApiUrl = `https://api.scs-tawassolsihi.com/Messages/doctor/${userId}/rooms/${roomId}`;
    const postApiUrl = `https://api.scs-tawassolsihi.com/Messages/doctor/${userId}/rooms/${roomId}`;
