...
const ChatList = () => {
    ...
    const apiUrl = `https://api.scs-tawassolsihi.com/Messages/malad/${user?.id}/rooms`;
                                    ...
                                    <li key={chat.id} className="">
                                        ...
                                        >
                                            <img
                                                ...
                                                src={`https://api.scs-tawassolsihi.com/${chat?.Doctor?.profile_pic_link}`}
                                                alt=""
                                            />
