...
const ChatRoom = () => {
    ...
    const chatApiUrl = `https://api.scs-tawassolsihi.com/Messages/malad/${userId}/rooms/${roomId}`;
    const postApiUrl = `https://api.scs-tawassolsihi.com/Messages/malad/${userId}/rooms/${roomId}`;
