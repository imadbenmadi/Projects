...
function Info() {
    ...
    const checkFollowStatus = async () => {
        try {
            const response = await axios.get(
                `https://api.scs-tawassolsihi.com/Malads/${company?.id}/Companies/${company?.id}/isFollowing`,
    ...
    const handleFollow = async () => {
        ...
        try {
            const response = await axios.post(
                `https://api.scs-tawassolsihi.com/Malads/${company?.id}/Companies/${company?.id}/Follow`,
                {},
                { withCredentials: true }
            );
    ...
    const handleUnfollow = async () => {
        ...
        try {
            const response = await axios.post(
                `https://api.scs-tawassolsihi.com/Malads/${company?.id}/Companies/${company?.id}/Unfollow`,
                {},
                { withCredentials: true }
            );
