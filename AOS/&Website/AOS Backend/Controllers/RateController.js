...
const RateProduct = async (req, res) => {
    ...
    try {
        ...
        product_in_db.Product_RatingAverage =
            product_in_db.Ratings.reduce((acc, item) => acc + item.rate, 0) /
            product_in_db.Ratings.length;
...
const RateStore = async (req, res) => {
    ...
    try {
        ...
        Store_in_db.Store_RatingAverage =
            Store_in_db.Ratings.reduce((acc, item) => acc + item.rate, 0) /
            Store_in_db.Ratings.length;
