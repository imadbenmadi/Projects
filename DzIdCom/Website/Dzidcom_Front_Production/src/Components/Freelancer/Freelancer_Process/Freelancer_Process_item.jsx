...
function Freelancer_Process_item() {
    ...
    const handle_send_Feedback = async () => {
        ...
        try {
            let response = await axios.post(
                `https://api.dzidcom.com/Freelancers/${user?.id}/Rate/${project.ClientId}`,
                {
                    Rate,
                    Comment,
    ...
    const uploadFile = async () => {
        ...
        try {
            ...
            let Image_Response = await Axios.post(
                `https://api.dzidcom.com/upload/Work`,
                formData,
                {
                    withCredentials: true,
                    validateStatus: () => true,
    ...
    useEffect(() => {
        ...
        const FetchProject = async ({ setProject, setLoading, setError }) => {
            ...
            try {
                const response = await axios.get(
                    `https://api.dzidcom.com/Freelancers/${user?.id}/Process/${projectId}`,
                    {
                        withCredentials: true,
                        validateStatus: () => true,
                    }
        ...
        const fetchRejections = async ({ SetRejections }) => {
            ...
            try {
                const response = await axios.get(
                    `https://api.dzidcom.com/Freelancers/${user?.id}/${projectId}/Rejections`,
                    {
                        withCredentials: true,
                        validateStatus: () => true,
                    }
