...
const ChatList = ({ userId }) => {
    ...
    const apiUrl = `https://api.dzidcom.com/Messages/freelancer/${user?.id}/rooms`;
    ...
    const handleChatClick = (chatId) => {
        setChats((prevChats) =>
            prevChats.map((chat) =>
                chat.id === chatId
                    ? { ...chat, freelancerUnreadMessages: 0 }
                    : chat
            )
        );
    };
    ...
    return (
        <div className="">
            {chats.length === 0 ? (
                <p className="text-sm  text-center w-full font-semibold text-gray_v pt-12">
                    No chats available.
                </p>
            ) : (
                <>
                                    ...
                                    <li key={chat.id} className="">
                                        ...
                                        >
                                            <img
                                                ...
                                                src={`https://api.dzidcom.com/${chat?.Client?.profile_pic_link}`}
                                                alt=""
                                            />
