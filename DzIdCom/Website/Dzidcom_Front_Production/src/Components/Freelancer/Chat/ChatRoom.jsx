...
const ChatRoom = () => {
    ...
    const chatApiUrl = `https://api.dzidcom.com/Messages/freelancer/${userId}/rooms/${roomId}`;
    const postApiUrl = `https://api.dzidcom.com/Messages/freelancer/${userId}/rooms/${roomId}`;
