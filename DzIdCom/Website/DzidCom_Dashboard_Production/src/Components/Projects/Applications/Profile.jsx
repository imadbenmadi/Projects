        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    `https://api.dzidcom.com/Admin/Users/Freelancers/${user.id}/Feedbacks`,
                    {
        ...
        <div className="flex flex-row  items-start justify-around  pb-10">
            <div className="  flex  justify-center max-w-[350px] gap-6 md:gap-12">
                {user?.profile_pic_link ? (
                    <img
                        src={"https://api.dzidcom.com/" + user.profile_pic_link}
                        onError={(e) => {
...
function Profile() {
    ...
    const handle_Accept = async () => {
        ...
        try {
            let response = await axios.post(
                `https://api.dzidcom.com/Admin/Applications/${projectId}/${userId}/Accept`,
                {
                    Money: money,
                    DeadLine: deadLine,
                },
    ...
    const handle_Reject = async () => {
        ...
        try {
            let response = await axios.post(
                `https://api.dzidcom.com/Admin/Applications/${projectId}/${userId}/Reject`,
                {},
                // Reason,
                {
                    withCredentials: true,
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                const response = await axios.get(
                    `https://api.dzidcom.com/Admin/Users/Freelancers/${userId}`,
                    {
                        withCredentials: true,
                        validateStatus: () => true,
                    }
