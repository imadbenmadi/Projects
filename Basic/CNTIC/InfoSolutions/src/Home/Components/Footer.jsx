...
import logo_white from "../../../public/Cntic_white.png";
function Footer() {
    return (
        <div className=" flex justify-center items-center md:gap-6 bg-Blue">
            <div className="flex  flex-col items-center bg-Blue text-center text-surface dark:text-white">
          ...
          >
            <span className="mx-auto [&>svg]:h-5 [&>svg]:w-5">
              ...
              >
                ...
                <div className="w-full bg-Blue p-4 text-center">
